...
Bu yazılımın ve ilgili belgelendirme dosyalarının ("Yazılım") bir kopyasını elde eden herhangi bir kişiye, yazılımı kullanma, kopyalama, değiştirme, birleştirme, yayımlama, dağıtma, alt lisans verme ve/veya kopyalarını satma hakları da dahil olmak üzere, ancak bunlarla sınırlı olmamak kaydıyla, aşağıdaki koşullara tabi olarak ücretsiz izin verilmektedir:
...
YAZILIM "OLDUĞU GİBİ", HERHANGİ BİR GARANTİ OLMAKSIZIN SAĞLANMAKTADIR. HİÇBİR DURUMDA YAZARLAR VEYA TELİF HAKKI SAHİPLERİ, YAZILIMLA İLGİLİ OLARAK HERHANGİ BİR İDDİA, HASAR VEYA DİĞER YÜKÜMLÜLÜKLERDEN SORUMLU TUTULAMAZ.
